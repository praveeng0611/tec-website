    ...
    <footer className="bg-tec-light dark:bg-tec-navy border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Support */}
          <div>
            <h4 className="font-700 text-tec-navy dark:text-white mb-4 text-sm">Support</h4>
            <ul className="space-y-2.5">
              {support.map((item) => (
                <li key={item} className="flex items-center gap-2">
                  <span className="w-1 h-1 rounded-full bg-tec-cyan flex-shrink-0" />
                  <Link href="#" className="text-sm text-gray-500 dark:text-gray-400 hover:text-tec-cyan dark:hover:text-tec-cyan transition-colors">{item}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Company */}
          <div>
            <h4 className="font-700 text-tec-navy dark:text-white mb-4 text-sm">Company</h4>
            <ul className="space-y-2.5">
              {company.map((item) => (
                <li key={item} className="flex items-center gap-2">
                  <span className="w-1 h-1 rounded-full bg-tec-cyan flex-shrink-0" />
          ...
          {/* Newsletter */}
          <div>
            <h4 className="font-700 text-tec-navy dark:text-white mb-3 text-sm">Newsletter</h4>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-400">Copyright © {new Date().getFullYear()} TEC, All rights reserved.</p>
